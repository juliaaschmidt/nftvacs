...
contract Vaccination is ERC721, ERC721Burnable, ERC721Enumerable, Ownable {
    ...
    // metadata uri
    string public baseUri = "https://nftstorage.link/ipfs/bafybeihgfq5t57qaow2m6ont6atrwmd5j3yepf2ierglc5rcj33rosr6fq/";

    // "https://nftstorage.link/ipfs/bafybeihdbw2tuziatjtgj4nml5ri5s44jkftqpj4qqhq5yjdv4u4i3sdne";

    //static
    string public baseExtension = ".json";

    constructor() ERC721("VacToken", "VTK")
    public {
    }
    ...
    function setBaseUri(string memory _baseTokenURI) public adminOnly {
